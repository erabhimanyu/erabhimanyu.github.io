...
<head>
    ...
    <meta name="description" content="To learn is to love">
	<meta property="og:title" content="A Learning mind" />
<meta property="og:type" content="website" />
<meta property="og:url" content="http://localhost:4000///plugin/projector/DataProjector.js" />
...
<meta name="citation_author" content="Surya R. Kalidindi">
    ...
    <title>A Learning mind</title>

    <link rel="canonical" href="http://localhost:4000/plugin/projector/DataProjector.js">
...
<nav class="navbar navbar-default navbar-custom navbar-fixed-top">
    <div class="container-fluid">
        ...
        <div class="navbar-header page-scroll">
            ...
            <a class="navbar-brand" href="/">A Learning mind</a>
        </div>
        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <div class="site-heading" style="padding: 75px 0">
                    ...
                    <h1>A Learning mind</h1>
                    <hr class="small">
                    <span class="subheading">To learn is to love</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <ul class="list-inline text-center">
                    ...
                    <li>
                        <a href="https://www.facebook.com/er.abhii" target="_blank">
                    ...
                    <li>
                        <a href="https://github.com/erabhimanyu" target="_blank">
                            <span class="fa-stack fa-lg">
                                <i class="fa fa-circle fa-stack-2x"></i>
                ...
                <p class="copyright text-muted"> Copyright © <a href="#" target="_blank">Abhimanyu Arora</a></p>
            </div>
        </div>
    </div>
</footer>
